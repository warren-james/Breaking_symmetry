...
```{r HoopSizeFacets, include=T, echo=F, fig.width = 10, fig.height = 10, fig.cap = "_Facet plots for the Hoop Size experiment_"}
...
``` {r TwoThrowFacets, include = T, echo = F, fig.width = 10, fig.cap = "_Facet plots for each participant in the Two Throw experiment_"}
# process 
...
```{r TwoThrowPlts, include = T, echo = F, fig.asp = .65, fig.cap = "_The left hand plots show the Prior preditcions for the Two Throw experiment. The right hand plots show the Posterior predictions for the Two Throw expeirment._"}
# get legend 
...
``` {r RewardFacets, include = T, echo = F, fig.asp = .75, fig.cap = "_Facet plots for the Rewards experiment_"}
...
```{r PltRewardestimates, echo = F, include = T, warning = F, fig.asp=.75, fig.cap="_Posterior distributions for the Reward Study_"}
