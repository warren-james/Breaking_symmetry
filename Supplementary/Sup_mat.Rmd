...
```{r HoopSizePriors, include = T, echo = F, warning = F,  fig.asp = .45, fig.cap="_Prior predictive Check for the Hoop Size experiment_"}
...
```{r PltTwoThrowPriors, include = T, echo = F, fig.asp=.45, fig.cap="_Prior predictive Check for the Two Throw Experiment_"}
# get draws 
...
``` {r RewardPriorsPlt, include = T, echo = F, fig.asp = .45, fig.cap = "_Prior predictive Check for the Reward Study_"}
