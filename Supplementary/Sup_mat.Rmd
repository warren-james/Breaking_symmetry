...
```{r HoopSizeFacets, include=T, echo=F, fig.asp = .75, fig.cap = "_Facet plots for the Hoop Size experiment_"}
...
gridExtra::grid.arrange(plt_prior_hoopsize, plt_post_hoopsize, ncol = 2)
```
## Experiment 2: Two Throws
...
``` {r TwoThrowFacets, include = T, echo = F, fig.asp = .75, fig.cap = "_Facet plots for each participant in the Two Throw experiment_"}
# process 
