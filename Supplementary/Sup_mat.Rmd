...
We started by fitting a a beta distribution to the _Throwing Experiment_ data from Clarke and Hunt (2016) using the `fitdistrplus` package, as illustrated in Figure 1a. The fit with the empirical data is reasonable, although we under-estimate the frequency of standing positions $\sim0$.
...
```{r drawdistributions, include = T, echo = F, fig.height = 3, fig.cap="Warren write some text."}
load("../power/Hoop_size/scratch/sampled_data")
load("../power/Hoop_size/scratch/df_part2")
...
Figure 2 shows the uncertainty surrounding the mean estimate for the smallest difference tested (5\%). After 15 participants, the uncertainty surrounding the estimate appears to plateau which demonstrates that the sample size of 21 was sufficient to detect the effect. 

```{r  include = T, echo = F, fig.height = 3, fig.cap="We need a caption"}
