...
We started by fitting a a beta distribution to the _Throwing Experiment_ data from Clarke and Hunt (2016) using the `fitdistrplus` package. We then investigated how well we could detect various effects, and how this varied based on the sample size. See Figure 1a. 
