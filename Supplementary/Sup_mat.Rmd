...
The second dataset is comprised of 60 participants who took part in a computerised version of this task. *more details*
...
To perform our power analysis we ....
...
```{r Load in Hoop size data, inclued = F, echo = F, cache=TRUE}
